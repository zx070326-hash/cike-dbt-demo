...
type Risk = { id: string; userId: string; level: string; sources: string[]; status: string; createdAt: string; acknowledgedAt?: string; humanSlaDeadlineAt?: string };
type Participant = { userId: string; pseudonym: string; currentWeek: number; currentModuleId: string; completedModules: number; lastEmaAt: string | null; lastUrge: number | null; openRiskCount: number; lastActivityAt: string; inactiveDays: number; needsOutreach: boolean };
